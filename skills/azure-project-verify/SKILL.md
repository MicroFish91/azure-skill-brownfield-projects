---
name: azure-project-verify
description: "Add test coverage and build verification to a project scaffolded by azure-project-scaffold. Generates test infrastructure, mock services, test fixtures, unit tests for all routes/services/validation, runs lint sweep, and validates the build. WHEN: \"verify project\", \"add tests\", \"test scaffold\", \"verify scaffold\", \"add test coverage\", \"validate project\", \"project verify\", \"azure project verify\", \"add unit tests\", \"test coverage\", \"verify app\"."
license: MIT
metadata:
  author: Microsoft
